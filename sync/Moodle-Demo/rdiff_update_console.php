...
<?php 
 ...
 exec('sudo rm backup.sig; sudo rm backup.delta; sudo rm -r backup; sudo mkdir backup; sudo tar xf backup.mbz -C backup; sudo rdiffdir signature backup backup.sig');
